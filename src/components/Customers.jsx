...
const Customers =() => {
    return(
        ...
        <div className="m-16 p-12 bg-white overflow-hidden shadow-[0px_0px_90px_#f2f2f2] rounded-lg flex items-center sm:flex-wr">
            ...
            <p className="mb-8 max-w-2xl">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters</p>
            <p className="font-bold">Channery</p>
            </div>
        </div>
        <div className="flex justify-center space-x-0.5 translate-y-6" >
